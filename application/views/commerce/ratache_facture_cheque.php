                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <h3 class="kt-section__title">Ratacher une facture chèque</h3>
                            <div class="kt-section__info">Utilise les paramètres suivants pour ratacher une facture chèque</div>
                                        ...
                                        <form id="ratachement_form">
                                            <div class="row">
                                                <div class="col-lg-6 ml-lg-auto">
                                                    ...
                                                    <select class="form-control kt-select2 caisse" id="kt_select2_3" name="caisse">
                                                        <?php if(!empty($caisses)){ ?>
                                                            <?php echo '<option></option>'; ?>
                                                            <?php 
                                                                foreach($caisses as $values){
                                                                    if($values['code_agence'] == ""){  
                                                            ?> 
                                                                <?php echo '<option value='.$values['code_caisse'].'>'.$values['nom_emp'].' ---> '.$values['libelle_caisse'].'</option>'; ?>
                                                            <?php 
                                                                    }
                                                                }
                                                            ?> 
