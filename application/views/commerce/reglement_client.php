                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <h3 class="kt-section__title">REGLEMENT CLIENT</h3>
                            <div class="kt-section__info">Utilise les paramètres suivants pour faire un règlement client</div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 ml-lg-auto">
                                                    ...
                                                    <select class="form-control caisse" id="caisse" name="caisse">
                                                        <?php if(!empty($caisse)){?> 
                                                            <?php echo '<option value='.$caisse['code_caisse'].'>'.$caisse['nom_emp'].' ---> '.$caisse['libelle_caisse'].'</option>'; ?> 
                                                        <?php }else if(!empty($caisses)){ ?>
                                        ...
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                <div class="col-lg-6 ml-lg-auto">
                                                    ...
                                                    <select class="form-control document" id="kt_select2_9" name="document">
...
<div class="modal fade" tabindex="-1" role="dialog" id="rc">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Liste des règlement client</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        /**edit document debut */
        $(document).on("click", ".editdocrc", function(event){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#kt_select2_9").val(data.datas.code_document);
        ...
        $('#new_facture_form').on('submit', function(event){
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo base_url('form_facture_rc'); ?>",
                data: $(this).serialize(),
                dataType: "json",
                beforeSend:function(){
        ...
        $('#op_facture_form').on('submit', function(event){
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo base_url('op_facturerc'); ?>",
                data: $(this).serialize(),
                dataType: "json",
                beforeSend:function(){
        ...
        function reglementclient(page){
            $.ajax({
                method: "GET",
                url: "<?php echo base_url('all_rc_cli/');?>"+page,
                dataType: "json",
                success: function (data) {
        ...
        $(document).on("click", ".art_rc", function(event){
        ...
        /**rechercher une facture debut*/
         $("#recherche").keyup(function(){
            ...
            if(rechercher !==""){
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo base_url('all_rc_cli');?>",
