                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <h3 class="kt-section__title">BORDEREAU DE LIVRAISON</h3>
                            <div class="kt-section__info">Utilise les paramètres suivants pour faire un bordereau de livraison</div>
                                    
                            <div class="kt-widget__toolbar">
                                <button class="btn btn-icon btn-circle btn-label-facebook rcbtn">
                                    <i class="fa fa-eye"></i> 
                                </button> Historique
                            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="rc">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Liste des bordereaux de livraison</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <input type="search" id="recherche" name="recherche" class="form-control" placeholder="saisi ici le du nom client pour trouve son bon...">
                <span id="text"></span>
                <hr>
                
                <div class="list-group" id="rc_cli">
...
<script>
    $(document).ready(function () {
        ...
        $('#new_facture_form').on('submit', function(event){
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo base_url('form_b_l'); ?>",
                data: $(this).serialize(),
                dataType: "json",
                beforeSend:function(){
        ...
        $('#op_facture_form').on('submit', function(event){
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo base_url('operationfacture_bl'); ?>",
                data: $(this).serialize(),
                dataType: "json",
                beforeSend:function(){
        ...
        $(".rcbtn").click(function (e) { 
            e.preventDefault();
            bondelivraison(1);
        });
        function bondelivraison(page){
            $.ajax({
                method: "GET",
                url: "<?php echo base_url('allbordereaul/');?>"+page,
                dataType: "json",
                success: function (data) {
                    $("#rc_cli").html(data.infos);
        ...
        /**affiche la liste des articles d'un bon de livraison debut */
        $(document).on("click", ".art_bl", function(event){
        ...
        /**affiche la liste des article d'un bon de livraison fin */
            
        /**rechercher un bon debut*/
        $("#recherche").keyup(function(){
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo base_url('allbordereaul');?>",
        ...
        /**rechercher un bon fin*/


        /**edit document debut */
        $(document).on("click", ".editdocbl", function(event){
            event.preventDefault();
